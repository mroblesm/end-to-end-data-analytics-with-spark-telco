...
# Parameters: (1) Docker image tag (2) GCP region
# e.g. ./build-container-image.sh 1.0.0 us-central1
#........................................................................
...
BQ_CONNECTOR_JAR="spark-bigquery-with-dependencies_2.13-0.31.1.jar"
BQ_CONNECTOR_JAR_URI="gs://spark-lib/bigquery/${BQ_CONNECTOR_JAR}"
GCP_REGION=$2
...
COPY ${BQ_CONNECTOR_JAR} "${SPARK_EXTRA_JARS_DIR}"
...
wget -P . https://repo.anaconda.com/miniconda/Miniconda3-py39_23.3.1-0-Linux-x86_64.sh
...
# Build image
docker build . -f Dockerfile -t $DOCKER_IMAGE_FQN
